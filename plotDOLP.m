...
hold on;
plot(x,info_0_0(:,8),'b-s','DisplayName','measured data')
...
subplot(322)
plot(x_imp,imp_info_45_45(range,dolp_pos),'r-*','DisplayName','our simulated data')
hold on;
plot(x,info_45_45(:,8),'b-s','DisplayName','measured data')
...
subplot(323)
plot(x_imp,imp_info_90_90(range,dolp_pos),'r-*','DisplayName','our simulated data')
hold on;
plot(x,info_90_90(:,8),'b-s','DisplayName','measured data');
if plotAverageIntensity == 1
    hold on;
...
h=ylabel('DOLP');  set(h,'Fontsize',15); 
h=title('pl\_angle = 90\circ co\_angle = 90\circ');set(h,'Fontsize',15); 

subplot(324)
plot(x_imp,imp_info_135_135(range,dolp_pos),'r-*','DisplayName','our simulated data')
hold on;
plot(x,info_135_135(:,8),'b-s','DisplayName','measured data');
if plotAverageIntensity == 1
    hold on;
...
subplot(325)
plot(x_imp,imp_info_0_45(range,dolp_pos),'r-*','DisplayName','our simulated data')
hold on;
plot(x,info_0_45(:,8),'b-s','DisplayName','measured data');
if plotAverageIntensity == 1
    hold on;
...
subplot(326)
plot(x_imp,imp_info_0_m45(range,dolp_pos),'r-*','DisplayName','our simulated data')
hold on;
plot(x,info_0_m45(:,8),'b-s','DisplayName','measured data');
if plotAverageIntensity == 1
    hold on;
